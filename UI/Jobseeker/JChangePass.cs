...
{
    public partial class JChangePass : UserControl
    {
        public JChangePass()
        {
            InitializeComponent();
        ...
        private void updateLabel_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            {
                cmd.CommandText = "update JobseekerDetails set j_password ='" + txtPassCon.Text + "' where j_mail = '" + lbluser.Text + "' ";
                cmd.ExecuteNonQuery();
                con.Close();
                Clear();
        ...
        private void JChangePass_Load(object sender, EventArgs e)
        {
